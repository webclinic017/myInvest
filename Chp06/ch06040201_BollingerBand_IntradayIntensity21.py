# ch06040201_BollingerBand_IntradayIntensity21.py
...
print("\n---------- df ----------")
print(df, '\n')
df.to_excel('.\\chp06\\ch06040201_BollingerBand_IntradayIntensity21.xlsx')
...
plt.plot(df.index, df['close'], color='b', label='Close')   # 종가(close)를 그래프에 그린다.
