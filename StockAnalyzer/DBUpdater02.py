...
import calendar, json, pymysql, requests
import pandas as pd
...
class DBUpdater:
    ...
    def update_company_info(self):
        ...
        self.codes = {'005930':'삼성전자', '000660':'SK하이닉스', '051910':'LG화학', '035420':'NAVER'}
        '''
    ...
    def read_naver(self, code, company, pages_to_fetch):
        ...
        try:
            ...
            for page in range(1, pages+1):
                ...
                df = df.append(pg_df)
                tmnow = datetime.now().strftime('%Y-%m-%d %H:%M')
                print('[{}] {} ({}) : {:04d}/{:04d} pages are downloading...'.format(tmnow, company, code, page, pages), end="\n")
